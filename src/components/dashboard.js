        ...
        return(
            <div>
                <div className='dashboard-toggle'>
                    <button style={{textDecoration : showAnswered === false?'underline':null}} onClick={this.showUnaswered}>Unanswered</button>
                    <span>|</span>
...
function mapStateToProps({authedUser,users,polls}) {
    ...
    const unanswered = Object.keys(polls).
        ...
        map((id)=> polls[id]).sort((a,b) => b.timestamp - a.timestamp)
    return{
        answered,
        unanswered
    }
